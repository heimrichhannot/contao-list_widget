...
if (TL_MODE == 'BE')
{
    $GLOBALS['TL_JAVASCRIPT']['datatables-i18n']       =
        'composer/vendor/heimrichhannot/datatables-additional/datatables-i18n/datatables-i18n.min.js';
    ...
    $GLOBALS['TL_CSS']['datatables-core']       =
        'composer/vendor/heimrichhannot/datatables-additional/datatables.net-dt/css/jquery.dataTables.min.css';
